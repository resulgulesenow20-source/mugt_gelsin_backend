...
class CheapestFoodsPage extends StatelessWidget {
  final List<Restaurant> restaurants;

  const CheapestFoodsPage({super.key, required this.restaurants});
  ...
  Widget build(BuildContext context) {
    ...
    // Fiyata göre artan sırada sırala (En ucuzlar en üstte)
    allFoods.sort((a, b) => a.food.price.compareTo(b.food.price));

    return Scaffold(
      backgroundColor: AppColors.background,
      appBar: AppBar(
        title: Text(
          langProvider.get('cheapest'), // "En Ucuz Lezzetler" veya "Iň Arzan Tagamlar"
